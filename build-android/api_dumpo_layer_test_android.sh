...
adb $serialFlag push libs/$target_abi/libVkLayer_api_dump.so /data/local/debug/vulkan/
...
adb $serialFlag push ../layersvt/vk_layer_settings.txt /sdcard/Android

#adb $serialFlag shell setprop debug.vulkan.layer.1 VK_LAYER_LUNARG_api_dump

adb $serialFlag shell cmd gpu vkjson #&> apidump.output
